...
function Vt(e) {
    typeof N < "u" && N !== null && N.destroy(), Chart.defaults.elements.arc.borderWidth = 0, Chart.defaults.datasets.doughnut.cutout = "85%", N = new Chart(document.getElementById("leads-source"), {
        type: "doughnut",
        data: { datasets: [{ label: "My First Dataset", data: [32, 27, 25, 16], backgroundColor: [`rgb(${e})`, "rgb(35, 183, 229)", "rgb(245, 184, 73)", "rgb(38, 191, 148)"] }] },
        plugins: [{
            afterUpdate: function(t) { t.getDatasetMeta(0).data.forEach(function(o) { o.round = { x: (t.chartArea.left + t.chartArea.right) / 2, y: (t.chartArea.top + t.chartArea.bottom) / 2, radius: (o.outerRadius + o.innerRadius) / 2, thickness: (o.outerRadius - o.innerRadius) / 2, backgroundColor: o.options.backgroundColor } }) },
            afterDraw: t => {
                const { ctx: r, canvas: o } = t;
                t.getDatasetMeta(0).data.forEach(l => {
...
if (z !== null) {
    z.innerHTML = "";
    var V = { chart: { type: "line", height: 40, sparkline: { enabled: !0 } }, stroke: { show: !0, curve: "smooth", lineCap: "butt", colors: void 0, width: 2.5, dashArray: 0 }, fill: { gradient: { enabled: !1 } }, series: [{ name: "Value", data: [20, 14, 19, 10, 25, 20, 22, 9, 12] }], yaxis: { min: 0, show: !1, axisBorder: { show: !1 } }, xaxis: { show: !1, axisBorder: { show: !1 } }, colors: ["rgb(132, 90, 223)"] },
...
if (z !== null) {
    z.innerHTML = "";
    var or = { series: [{ name: "Price", data: [20, 38, 38, 72, 55, 63, 43, 76, 55, 80, 40, 80] }, { name: "Volume", data: [85, 65, 75, 38, 85, 35, 62, 40, 40, 64, 50, 89] }], chart: { height: 336, type: "line", zoom: { enabled: !1 }, dropShadow: { enabled: !0, enabledOnSeries: void 0, top: 5, left: 0, blur: 3, color: "#000", opacity: .1 } }, dataLabels: { enabled: !1 }, legend: { position: "top", horizontalAlign: "center", offsetX: -15, fontWeight: "bold" }, stroke: { curve: "smooth", width: "3", dashArray: [0, 5] }, grid: { borderColor: "#f2f6f7" }, colors: ["rgb(132, 90, 223)", "rgba(132, 90, 223, 0.3)"], yaxis: { title: { text: "Statistics", style: { color: "#adb5be", fontSize: "14px", fontFamily: "poppins, sans-serif", fontWeight: 600, cssClass: "apexcharts-yaxis-label" } } }, xaxis: { type: "month", categories: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], axisBorder: { show: !0, color: "rgba(119, 119, 142, 0.05)", offsetX: 0, offsetY: 0 }, axisTicks: { show: !0, borderType: "solid", color: "rgba(119, 119, 142, 0.05)", width: 6, offsetX: 0, offsetY: 0 }, labels: { rotate: -90 } } },
...
if (m !== null) {
    m.innerHTML = "";
    var I = { chart: { height: 120, width: 100, type: "radialBar" }, series: [48], colors: ["#23b7e5"], plotOptions: { radialBar: { hollow: { margin: 0, size: "50%", background: "#fff" }, dataLabels: { name: { offsetY: -10, color: "#4b9bfa", fontSize: "10px", show: !1 }, value: { offsetY: 5, color: "#4b9bfa", fontSize: "12px", show: !0, fontWeight: 800 } } } }, stroke: { lineCap: "round" }, labels: ["Followers"] },
...
if (m !== null) {
    m.innerHTML = "";
    var I = { chart: { height: 120, width: 100, type: "radialBar" }, series: [65], colors: ["#f7b731"], plotOptions: { radialBar: { hollow: { margin: 0, size: "50%", background: "#fff" }, dataLabels: { name: { offsetY: -10, color: "#4b9bfa", fontSize: "10px", show: !1 }, value: { offsetY: 5, color: "#4b9bfa", fontSize: "12px", show: !0, fontWeight: 800 } } } }, stroke: { lineCap: "round" }, labels: ["Views"] },
...
if ($ !== null) {
    $.innerHTML = "";
    var Le = { series: [{ name: "Designing", data: [44, 55, 41, 67, 22, 43, 44, 55, 41, 67, 22, 43] }, { name: "Development", data: [13, 23, 20, 8, 13, 27, 13, 23, 20, 8, 13, 27] }, { name: "SEO", data: [11, 17, 15, 15, 21, 14, 11, 17, 15, 15, 21, 14] }], chart: { type: "bar", height: 310, stacked: !0, toolbar: { show: !0 }, zoom: { enabled: !0 } }, grid: { borderColor: "#f1f1f1", strokeDashArray: 3 }, responsive: [{ breakpoint: 480, options: { legend: { position: "bottom", offsetX: -10, offsetY: 0 } } }], colors: ["rgba(132, 90, 223, 1)", "rgba(132, 90, 223, 0.5)", "rgba(132, 90, 223, 0.2)"], legend: { show: !1, position: "top" }, plotOptions: { bar: { columnWidth: "20%" } }, dataLabels: { enabled: !1 }, xaxis: { categories: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"] }, fill: { opacity: 1 } },
...
if (w !== null) {
    ...
    var Be = {
            ...
            chart: { id: "area-datetime", fontFamily: "Roboto, Arial, sans-serif", type: "area", height: 320, zoom: { autoScaleYaxis: !0 }, toolbar: { show: !1 } },
            ...
            fill: { type: "gradient", gradient: { shadeIntensity: 1, opacityFrom: .5, opacityTo: .7, stops: [0, 100] } }
        },
...
if (G !== null) {
    ...
    if (o !== null) {
        ...
        var e = {
                ...
                xaxis: { min: 0, max: 50, labels: { show: !1 }, axisBorder: { show: !1 } },
    ...
    if (typeof jsVectorMap < "u") {
        var n = [{ name: "Russia", coords: [61, 105], style: { fill: "#28d193" } }, { name: "Greenland", coords: [72, -42], style: { fill: "#ff8c33" } }, { name: "Canada", coords: [56, -106], style: { fill: "#ff534d" } }, { name: "Palestine", coords: [31.5, 34.8], style: { fill: "#ffbe14" } }, { name: "Brazil", coords: [-14.235, -51.9253], style: { fill: "#4b9bfa" } }],
...
function Ir(e) {
    var t = { series: [{ data: [17, 22, 37, 47, 39, 28, 14], name: "Revenue" }], chart: { type: "bar", height: 235, toolbar: { show: !1 }, dropShadow: { enabled: !0, enabledOnSeries: void 0, top: 6, left: 6, blur: 3, color: "#000", opacity: .05 } }, plotOptions: { bar: { columnWidth: "35%", borderRadius: 4, horizontal: !1, colors: { ranges: [{ from: 41, to: 1 / 0, color: "rgb(" + e + ")" }, { from: 0, to: 40, color: "rgba(" + e + ", 0.2)" }] } } }, dataLabels: { enabled: !1 }, grid: { show: !1, borderColor: "transparent", padding: { top: 0, right: 0, bottom: 0, left: 0 }, yaxis: { lines: { show: !1 } } }, xaxis: { categories: ["Mon", "Tues", "Wed", "Thu", "Fri", "Sat", "Sun"], colors: "#fff", axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { rotate: -90, style: { fontFamily: "Inter, sans-serif" } } }, yaxis: { colors: "#fff", axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { show: !1 } } };
...
function Cr(e) {
    var t = { series: [{ name: "Job Applied", type: "line", data: [25, 50, 30, 55, 20, 45, 30] }, { name: "Job Viewed", type: "area", data: [35, 25, 40, 30, 45, 35, 60] }], chart: { height: 348, type: "line", stacked: !1, toolbar: { show: !1 }, dropShadow: { enabled: !0, enabledOnSeries: void 0, top: 7, left: 1, blur: 3, color: "#000", opacity: .2 } }, colors: ["rgba(" + e + ", 1)", "rgba(" + e + ", 0.1)"], grid: { borderColor: "#e9edf4", padding: { top: 10, right: 0, bottom: 0, left: 0 } }, stroke: { width: [2, 2], curve: "smooth", dashArray: [0, 4] }, labels: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], markers: { size: 4, hover: { size: 5 } }, fill: { opacity: [.85, .25, 1], gradient: { inverseColors: !1, shadeIntensity: 1, shade: "light", type: "vertical", opacityFrom: .85, opacityTo: .55, stops: [0, 100, 100, 100] } }, legend: { show: !0, position: "top", fontFamily: "Inter, sans-serif", markers: { width: 10, height: 10 } }, xaxis: { type: "week", axisBorder: { show: !0, color: "rgba(119, 119, 142, 0.05)", offsetX: 0, offsetY: 0 }, axisTicks: { show: !0, borderType: "solid", color: "rgba(119, 119, 142, 0.05)", width: 6, offsetX: 0, offsetY: 0 }, labels: { rotate: -90 } }, yaxis: { title: { style: { color: "#adb5be", fontSize: "14px", fontFamily: "Inter, sans-serif", fontWeight: 600 } }, labels: { formatter: function(o) { return o.toFixed(0) + "" } } }, tooltip: { shared: !0, intersect: !1, y: { formatter: function(o) { return typeof o < "u" ? o.toFixed(0) + " points" : o } } } };
...
class Pr {
    ...
    init(t, r) {
        this.reference = t, this.popperTarget = r, this.instance = Popper.createPopper(this.reference, this.popperTarget, { placement: "bottom", strategy: "relative", resize: !0, modifiers: [{ name: "computeStyles", options: { adaptive: !1 } }] }), document.addEventListener("click", l => this.clicker(l, this.popperTarget, this.reference), !1);
...
Dr.forEach(e => {
    e.addEventListener("click", () => {
        ...
        if (!(t.getAttribute("data-nav-style") === "menu-hover" && t.getAttribute("data-toggled") === "menu-hover-closed" && window.innerWidth >= 992 || t.getAttribute("data-nav-style") === "icon-hover" && t.getAttribute("data-toggled") === "icon-hover-closed" && window.innerWidth >= 992)) {
            const r = e.closest(".nav.sub-open");
            r && r.querySelectorAll(":scope > ul > .slide.has-sub > a").forEach(o => {
                (o.nextElementSibling.style.display === "block" || window.getComputedStyle(o.nextElementSibling).display === "block") && Z(o.nextElementSibling)
            }), Ft(e.nextElementSibling)
        }
    })
});
Tr.forEach(e => {
    document.querySelector("html"), e.addEventListener("click", () => {
        const t = e.closest(".slide-menu");
        t && t.querySelectorAll(":scope .slide.has-sub > a").forEach(r => {
            var o;
            r.nextElementSibling && ((o = r.nextElementSibling) == null ? void 0 : o.style.display) === "block" && Z(r.nextElementSibling)
        }), Ft(e.nextElementSibling)
    })
});
let ft, k;
(() => {
    ...
    ft = document.querySelector(".sidemenu-toggle"), ft.addEventListener("click", S);
...
function S() {
    ...
    if (window.innerWidth >= 992) {
        if (t === "vertical") {
            switch (g.removeEventListener("mouseenter", T), g.removeEventListener("mouseleave", P), g.removeEventListener("click", X), Y.removeEventListener("click", _), document.querySelectorAll(".main-menu li > .side-menu__item").forEach(n => n.removeEventListener("click", Me)), e.getAttribute("data-vertical-style")) {
                case "closed":
                    e.removeAttribute("data-nav-style"), e.getAttribute("data-toggled") === "close-menu-close" ? e.removeAttribute("data-toggled") : e.setAttribute("data-toggled", "close-menu-close");
                    break;
                case "overlay":
                    e.removeAttribute("data-nav-style"), e.getAttribute("data-toggled") === "icon-overlay-close" ? (e.removeAttribute("data-toggled", "icon-overlay-close"), g.removeEventListener("mouseenter", T), g.removeEventListener("mouseleave", P)) : window.innerWidth >= 992 ? (localStorage.getItem("ynexlayout") || e.setAttribute("data-toggled", "icon-overlay-close"), g.addEventListener("mouseenter", T), g.addEventListener("mouseleave", P)) : (g.removeEventListener("mouseenter", T), g.removeEventListener("mouseleave", P));
                    break;
                case "icontext":
                    e.removeAttribute("data-nav-style"), e.getAttribute("data-toggled") === "icon-text-close" ? (e.removeAttribute("data-toggled", "icon-text-close"), g.removeEventListener("click", X), Y.removeEventListener("click", _)) : (e.setAttribute("data-toggled", "icon-text-close"), window.innerWidth >= 992 ? (g.addEventListener("click", X), Y.addEventListener("click", _)) : (g.removeEventListener("click", X), Y.removeEventListener("click", _)));
                    break;
                case "doublemenu":
                ...
                case "detached":
                    ...
                    break;
                case "default":
                    Ce(), e.removeAttribute("data-toggled")
            }
            switch (e.getAttribute("data-nav-style")) {
                case "menu-click":
                    e.getAttribute("data-toggled") === "menu-click-closed" ? e.removeAttribute("data-toggled") : e.setAttribute("data-toggled", "menu-click-closed");
                    break;
                case "menu-hover":
                    e.getAttribute("data-toggled") === "menu-hover-closed" ? (e.removeAttribute("data-toggled"), E()) : (e.setAttribute("data-toggled", "menu-hover-closed"), b());
                    break;
                case "icon-click":
                    e.getAttribute("data-toggled") === "icon-click-closed" ? e.removeAttribute("data-toggled") : e.setAttribute("data-toggled", "icon-click-closed");
                    break;
                case "icon-hover":
                    e.getAttribute("data-toggled") === "icon-hover-closed" ? (e.removeAttribute("data-toggled"), E()) : (e.setAttribute("data-toggled", "icon-hover-closed"), b());
                    break
            }
        }
...
function $r() {
    let e = document.querySelector("html");
    e.setAttribute("data-nav-layout", "vertical"), e.setAttribute("data-vertical-style", "doublemenu"), S();
...
function E() {
    ...
    e = location.pathname == "/" ? "index" : location.pathname.substring(1), e = e.substring(e.lastIndexOf("/") + 1), document.querySelectorAll(".side-menu__item").forEach(r => {
        if (e === "/" && (e = "index"), r.getAttribute("href") === window.location.href) {
            r.classList.add("active"), r.parentElement.classList.add("active");
            let o = r.closest("ul");
            if (r.closest("ul:not(.main-menu)"), o) {
                if (o.classList.add("active"), o.previousElementSibling.classList.add("active"), o.parentElement.classList.add("active"), o.parentElement.classList.contains("has-sub")) {
                    let l = o.parentElement.parentElement.parentElement;
...
function b() {
    document.querySelectorAll("ul.slide-menu").forEach(t => {
        ...
        if (r) { let l = r.closest("ul.main-menu"); for (; l;) r.classList.add("active"), Z(r), r = r.parentElement.closest("ul"), o = r.closest("ul:not(.main-menu)"), o || (l = !1) }
    })
}

function Yr() {
    let e = document.querySelector(".slide-left"),
        t = document.querySelector(".slide-right");

    function r() {
        let o = document.querySelectorAll(".slide"),
    ...
    ee(), e.addEventListener("click", () => {
        ...
        let v = document.querySelector(".main-menu > .slide.open"),
...
}["switcher-icon-click", "switcher-icon-hover", "switcher-horizontal"].map(e => {
    document.getElementById(e) && document.getElementById(e).addEventListener("click", () => {
...
function $t() {
    var t;
    let e = document.querySelector("html");
    document.querySelector("#style").href.includes("bootstrap.min.css") || (t = document.querySelector("#style")) == null || t.setAttribute("href", "assets/libs/bootstrap/css/bootstrap.min.css"), e.setAttribute("dir", "ltr"), document.querySelector("#switcher-ltr").checked = !0, L()
}
...
if (document.querySelector("#switcher-canvas")) {
    ...
    for (const [v, B] of l) {
        ...
        x.innerHTML = v, n.push(x), x.addEventListener("click", () => {
            const C = document.createElement("p");
            e.appendChild(C), u && u.destroyAndRemove();
            for (const A of n) A.classList[A === x ? "add" : "remove"]("active");
            u = new Pickr(Object.assign({ el: C, theme: v, default: "#845adf" }, B)), u.on("changestop", (A, R) => {
                let d = R.getColor().toRGBA();
                document.querySelector("html").style.setProperty("--primary-rgb", `${Math.floor(d[0])}, ${Math.floor(d[1])}, ${Math.floor(d[2])}`), localStorage.setItem("primaryRGB", `${Math.floor(d[0])}, ${Math.floor(d[1])}, ${Math.floor(d[2])}`), q()
            })
        }), t.appendChild(x)
    }
    n[0].click();
    ...
    for (const [v, B] of l) {
        const x = document.createElement("button");
        x.innerHTML = v, h.push(x), x.addEventListener("click", () => {
            const C = document.createElement("p");
            r.appendChild(C), y && y.destroyAndRemove();
            for (const A of n) A.classList[A === x ? "add" : "remove"]("active");
            y = new Pickr(Object.assign({ el: C, theme: v, default: "#845adf" }, B)), y.on("changestop", (A, R) => {
                let d = R.getColor().toRGBA(),
